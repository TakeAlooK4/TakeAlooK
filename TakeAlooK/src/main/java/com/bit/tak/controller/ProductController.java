...
public class ProductController {
	...
	public String productDetailPage(Model model, int prNo,HttpSession session,String nickname) {
		...
		model.addAttribute("reviewList",productReviewRepo.findByReviewId(prNo));
		model.addAttribute("questionList", qnaRepo.findByQnaId(prNo));
	...
	@ResponseBody
	public String questionInsert(Model model,Muser nickname,Product product,P_Qna qna) {
		qna.setProduct(product);
		qna.setUser(nickname);
	...
	@ResponseBody
	public String deleteQna(P_Qna qna) {


		qnaRepo.deleteById(qna.getPQno());

		return "success";
	}
	@RequestMapping("/deleteReview.do")
	@ResponseBody
	public String deleteReview(P_Review reviewNo) {


		productReviewRepo.deleteById(reviewNo.getReviewNo());
	...
	public void productDelete(@RequestParam(value = "prNo")int prNo){
		
		productRepo.deleteById(prNo);
